...
// cadena.toLowerCase;
// function CompararCadena(cadena) {
...
function ComprobarCadena(cadena) {
  ...
  let cadenaReverse = cadena.toLowerCase().split("").reverse();
  cadena = cadena.toLowerCase().split("");
  if (cadena.join() == cadenaReverse.join()) {
    return "las 2 son iguales";
  } else {
    return "las 2 no son iguales";
  }
}
